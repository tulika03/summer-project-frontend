      ...
      <v-flex  xs12 sm10 md9 offset-sm1 offset-md2>
        <v-card>
          <v-toolbar color="indigo" dark>
            <v-toolbar-title>Update Jobsite</v-toolbar-title>
          </v-toolbar>
          <v-card-text>
            <v-form>
              ...
              <v-text-field
                label="Job site Name"
                v-model="jobsites.jobsite_name"
                name="jobsite_name"
                required
                :rules="nameRules"
              >{{ jobsites.jobsite_name }}</v-text-field>

              <v-text-field
                label="Client Name"
                v-model="jobsites.client_name"
                name="client_name"
                required
                :rules="nameRules"
              >
                {{ jobsites.client_name }}
              </v-text-field>
              ...
              <v-flex xs12>
                <v-text-field
                  ...
                  :counter="400"
                  v-model="jobsites.client_address"
                  label="Address"
                  required
                >
                  {{ jobsites.client_address }}
                </v-text-field>
              </v-flex>
              ...
              <v-text-field
                label="Contact No."
                v-model="jobsites.client_contact"
                required
                :rules="nameRules"
              >
                {{ jobsites.client_contact }}
              </v-text-field>

              <v-text-field
                label="Client Email"
                v-model="jobsites.client_email"
                required
              >
                {{ jobsites.client_email }}
              </v-text-field>
